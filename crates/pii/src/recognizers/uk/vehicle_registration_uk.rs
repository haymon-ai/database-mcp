...
#[must_use]
pub fn vehicle_registration_uk() -> Recognizer {
    ...
    Recognizer::new(Entity::VehicleRegistrationUk, patterns)
        ...
        .with_name("VehicleRegistrationUkRecognizer")
        .with_category(Category::Government)
}

#[cfg(test)]
mod tests {
    use super::vehicle_registration_uk;
    ...
    #[test]
    fn recognizes_vehicle_registration_uk() {
